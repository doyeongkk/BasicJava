...
public class ArrayListClass {
	...
	public static void main(String[] args) {
		...
		ArrayList sample = new ArrayList();      //타입에 상관없이 값 저장할 수 있다. 
		...
		//따라서 제네릭의 사용이 권장된다.
		ArrayList<Integer> list = new ArrayList<>();       // < >이게 제네릭임.
		
		list.add(10);
//		list.add("abc"); //저장되면 안되는게 저장되서 컴파일 에러 발생
		list.add(20);
